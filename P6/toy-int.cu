...
__global__ void kernelAdd(int *dvalues, int numOperations,
...
int main(int argc, char **argv)
{
    ...
    int *colptr, *rowind;
    int *values;  // POINT 4: Puedes usar int para medir el rendimeinto en operaciones en punto fijo
    ...
    int *blocks;
    int *threads;
    int *dvalues;  // POINT 5: This declaration is binded to hints MU2 and MU4
    ...
    int valuesSize = nnzero * sizeof(int);
    ...
    opIntensity = numOperationsPerValue / sizeof(int);
